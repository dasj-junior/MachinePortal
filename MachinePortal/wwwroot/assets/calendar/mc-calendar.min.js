!(function (e, t) {
    ...
    return (() => {
        ...
        var e = {
            422: (e, t, n) => {
                n.d(t, { default: () => _e });
                var a = { DMY: ["calendar", "month", "year"], DY: ["calendar", "month", "year"], D: ["calendar", "month", "year"], MY: ["month", "year"], M: ["month"], Y: ["year"] };
                const r = {
                    el: null,
                ...
                var c = "show-calendar",
                    ...
                    b = function (e) {
                        ...
                        e.dispatchEvent(new CustomEvent(u, { bubbles: !0, detail: { dblclick: t, date: new Date(e.getAttribute("data-val-date")) } }));
                    },
                    g = function (e, t) {
                ...
                var k = function (e, t, n) {
                    ...
                    T = function (e, t) {
                        var n = (function (e, t) {
                            ...
                            i = n.vh,
                            l = n.dh,
                            o = n.elementOffsetTop,
                            s = n.elementOffsetleft,
                            d = (function (e) {
                                var t = e.elem,
                                    n = e.cal;
                        ...
                        return (
                            ...
                            p && (b = o + r.h + 5),
                            !p && h && (b = o - a.h - 5),
                            p || h || (y && (b = o + r.h + 5), !y && f && (b = o - a.h - 5), y || f || (b = (i - a.h) / 2)),
                            { top: b, left: g }
                        );
                    },
                    O = function (e) {
                            ...
                            close: function () {
                                ...
                                this.closed ||
                                    ...
                                    ((r = !1),
                                        (this.isClosing = !0),
                                        clearTimeout(n),
                                        e.dispatchEvent(new CustomEvent(i, { bubbles: !0 })),
                ...
                var q = function (e) {
                    ...
                    z = function (e, t) {
                        ...
                        return (
                            e.hasOwnProperty("minDate") && e.hasOwnProperty("maxDate") && E(e.minDate) >= E(e.maxDate) && n.push(new Error("maxDate should be greater than minDate")),
                            a.length > 0 && n.push.apply(n, P(a)),
                            n.length > 0
                                ? n.forEach(function (e) {
                                    return console.error(e);
                                })
                            ...
                            i = function (t) {
                                ...
                                return (
                                    ...
                                    (function (e, t) {
                                        ...
                                        return c || i;
                                    })(e, t) && r.push("mc-date--marked"),
                                    (function (e) {
                                        var t = e.date;
                                        return E(t) === E(new Date());
                                    })(t) && r.push("mc-date--today"),
                                    (t.classList = r.join(" ")),
                                    t
                                );
                            };
                    ...
                    return (
                        (function (e) {
                            var t = null,
                                ...
                                f = e.calendarDisplay,
                                y = e.calendarHeader,
                                D = e.currentMonthSelect,
                                k = e.currentYearSelect,
                                M = e.monthYearPreview,
                                L = e.monthNavPrev,
                                E = e.monthNavNext,
                                x = e.yearNavPrev,
                                T = e.yearNavNext,
                            ...
                            r.addEventListener(c, function (n) {
                                    ...
                                    if (!e.target.classList.contains("mc-month-year__cell--inactive")) {
                                        if (
                                            (S.forEach(function (e) {
                                                ...
                                                c && l.preview.target === s[0])
                                        ) {
                                            if (!m) return;
                                            return se(t, a);
                                        }
                                        var h = l.preview.year,
                                            p = d[l.header.month];
                                        ...
                                        var f = d.findIndex(function (e) {
                                            ...
                                            y = ce(t, new Date(h, f));
                                        (l.header.month = y.getMonth()),
                                            (l.preview.year = y.getFullYear()),
                                            "year" !== s[0] && (l.header.year = y.getFullYear()),
                                            (l.preview.month = y.getMonth()),
                                            "calendar" !== s[0] && (t.pickedDate = y),
                                            "calendar" !== s[0] && (l.display.setDate = y),
                                            "calendar" === s[0] && (l.calendar.setDate = y),
                                            (l.preview.setTarget = s[0]),
                                            (l.header.setTarget = s[0]),
                                            u && l.preview.target === s[0] && se(t, a);
                                    }
                                }),
                                r.addEventListener(p, function (e) {
                                    ...
                                    if (((a.pickedDate = r), de(a), JSON.stringify(t) === JSON.stringify(a))) {
                                        var c = t.store;
                                        (c.display.setDate = r),
                                            (c.calendar.setDate = c.calendar.date),
                                            "calendar" !== c.preview.target && ((c.preview.month = r.getMonth()), (c.preview.year = r.getFullYear()), (c.preview.setTarget = c.preview.target)),
                                            "month" === c.header.target && ((c.header.month = r.getMonth()), (c.header.year = r.getFullYear()), (c.header.setTarget = c.header.target));
                                    }
                                }),
                                ...
                                D.addEventListener(v, function (e) {
                                    if (n) {
                                        ...
                                        var a = C(),
                                            ...
                                            i = r.viewLayers,
                                            l = r.options,
                                            o = r.onMonthChangeCallbacks,
                                            s = r.onYearChangeCallbacks,
                                            d = l.customMonths,
                                        ...
                                        0 !== f &&
                                            ((k.innerHTML += U(u, y)),
                                                a.slide(k.children[0], k.children[1], u),
                                                s.forEach(function (e) {
                                                    return e.apply(null);
                                                })),
                                            (e.target.innerHTML += U(u, p.name)),
                                            a.slide(e.target.children[0], e.target.children[1], u),
                                            a.onFinish(function () {
                                                "calendar" === i[0] && (c.calendar.setDate = b),
                                                    "calendar" !== i[0] && (c.display.setDate = b),
                                                    "month" === i[0] && (t.pickedDate = b),
                                                    (c.header.year = b.getFullYear()),
                                                    (c.header.setMonth = b.getMonth()),
                                                    (c.preview.year = b.getFullYear()),
                                                    (c.preview.setMonth = b.getMonth()),
                                                    o.forEach(function (e) {
                                                        return e.apply(null);
                                                    }),
                                                    (n = !n);
                                ...
                                k.addEventListener(h, function (e) {
                                    if (n) {
                                        ...
                                        g &&
                                            ((D.innerHTML += U(a, g)),
                                                v.slide(D.children[0], D.children[1], a),
                                                o.forEach(function (e) {
                                                    return e.apply(null);
                                                })),
                                            b &&
                                            ((e.target.innerHTML += U(a, b)),
                                                v.slide(e.target.children[0], e.target.children[1], a),
                                                s.forEach(function (e) {
                                                    return e.apply(null);
                                                })),
                                            v.onFinish(function () {
                                                "calendar" === i[0] && (c.calendar.setDate = w),
                                                    "calendar" !== i[0] && (c.display.setDate = w),
                                                    "calendar" !== i[0] && (t.pickedDate = w),
                                                    (c.preview.year = w.getFullYear()),
                                                    (c.preview.setMonth = w.getMonth()),
                                                    (c.header.year = w.getFullYear()),
                                                    (c.header.setMonth = w.getMonth()),
                                                    (n = !n);
                                            });
                                    }
                                }),
                ...
                var ae = function (e) {
                    ...
                    ue = function (e, t) {
                        var n = e.displayDay,
                            ...
                            m = o.customWeekDays,
                            v = o.customMonths;
                        o.showCalendarDisplay ? i.classList.remove("u-display-none") : i.classList.add("u-display-none"),
                            i.setAttribute("data-target", l.display.target),
                            (c.innerText = u.getFullYear()),
                            "year" !== d && ((r.innerText = v[u.getMonth()]), "month" !== d && ((n.innerText = m[u.getDay()]), (a.innerText = u.getDate())));
                    },
                    me = function (e, t) {
                        var n = e.dateCells,
                            a = t.store,
                    ...
                    ve = function (e, t) {
                        var n = e.currentMonthSelect,
                            ...
                            r = e.calendarHeader,
                            c = t.store,
                            i = t.options.customMonths,
                            l = c.header,
                            o = l.target,
                            s = l.month,
                            d = l.year;
                        if (
                            (r.setAttribute("data-target", o),
                                (function (e, t) {
                                    ...
                                    var g = ie(t, d[v], "prev"),
                                        w = ie(t, d[v], "next"),
                                        _ = "year" !== m && le(s, h, "prev"),
                                        D = "year" !== m && le(s, h, "next");
                                    if (
                                        ("calendar" === m && 0 !== g.overlap && !_ && p.inactive(),
                                            "calendar" === m && 0 !== g.overlap && !_ && y.inactive(),
                                            "calendar" === m && 0 !== w.overlap && !D && f.inactive(),
                                            "calendar" === m && 0 !== w.overlap && !D && b.inactive(),
                                            l)
                                    ) {
                                        var k = new Date(h, v, 1),
                                            M = new Date(_, v + 1, 0),
                                            C = K(k, l),
                                            L = K(M, l);
                                ...
                                (function (e, t) {
                                    ...
                                    l.map(function (e, t) {
                                        var a = ["mc-month-year__cell"],
                                            l = new Date(Number(s), t),
                                            d = new Date(Number(s), t + 1, 0),
                                            u = r && E(d) < E(r),
                                            m = c && E(l) > E(c);
                                        e === o && a.push("mc-month-year__cell--picked"),
                                            (!u && !m && R(i, t) && Z(i, Number(s))) || a.push("mc-month-year__cell--inactive"),
                    ...
                    pe = function (e, t) {
                        ...
                        (n.classList = "mc-calendar"),
                            n.classList.add("mc-calendar--".concat(l)),
                ...
                function fe(e, t, n) {
                    ...
                    var a = null !== n.el ? document.querySelector(n.el) : null,
                        r = oe(n),
                        c = (function (e) {
                            var t = e.minDate,
                                n = e.maxDate,
                                ...
                                l = i[0],
                                o = i[i.length - 1],
                                s = a.length ? Math.min.apply(Math, te(a)) : null,
                                d = a.length ? Math.max.apply(Math, te(a)) : null,
                                u = s ? new Date(s, l.index, 1) : null,
                                m = d ? new Date(d, o.index + 1, 0) : null;
                            return t && u && (r = new Date(Math.max(t, u))), n && m && (c = new Date(Math.min(n, m))), r || (r = t || u), c || (c = n || m), { prevLimitDate: r, nextLimitDate: c };
                        })(n),
                        i = c.prevLimitDate,
                        l = c.nextLimitDate,
                        o = re(n),
