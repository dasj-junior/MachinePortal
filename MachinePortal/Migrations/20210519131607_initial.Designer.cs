...
namespace MachinePortal.Migrations
{
    ...
    [Migration("20210519131607_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MachinePortal.Areas.Identity.Data.DepartmentRead", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int?>("ReadDepartmentID");

                    b.HasKey("ID");

                    b.HasIndex("DepartmentID");

                    b.HasIndex("ReadDepartmentID");

                    b.ToTable("DepartmentRead");
                });

            modelBuilder.Entity("MachinePortal.Areas.Identity.Data.DepartmentWrite", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int?>("WriteDepartmentID");

                    b.HasKey("ID");

                    b.HasIndex("DepartmentID");

                    b.HasIndex("WriteDepartmentID");

                    b.ToTable("DepartmentWrite");
                });
            ...
            modelBuilder.Entity("MachinePortal.Areas.Identity.Data.DepartmentRead", b =>
                {
                    ...
                    b.HasOne("MachinePortal.Areas.Identity.Data.Department", "ReadDepartment")
                        .WithMany()
                        .HasForeignKey("ReadDepartmentID");
                });
            ...
            modelBuilder.Entity("MachinePortal.Areas.Identity.Data.DepartmentWrite", b =>
                {
                    ...
                    b.HasOne("MachinePortal.Areas.Identity.Data.Department", "WriteDepartment")
                        .WithMany()
                        .HasForeignKey("WriteDepartmentID");
                });
